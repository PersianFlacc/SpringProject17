...
import org.example.project17.Student;
...
public class UniversityLoggingAspect {
    ...
    @Before("org.example.project17.aspects.MyPointcuts.getStudents()")
    public void beforeGetStudentsLoggingAdvice() {
        System.out.println("beforeGetStudentsLoggingAdvice: логируем получение " +
                "списка студентов перед методом getStudents");
    }

    @AfterReturning(pointcut = "org.example.project17.aspects.MyPointcuts.getStudents()"
            , returning = "students")
